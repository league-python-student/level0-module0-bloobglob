...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring('Adjective', 'Please enter an adjective.')
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring('Liquid', 'Please enter a type of liquid.')
    # Get the player to enter a body part
    bodyPart = simpledialog.askstring('Body Part', 'Please enter a body part.')
    # Get the player to enter a verb
    verb = simpledialog.askstring('Verb', 'Please enter a verb.')
    # Get the player to enter a place
    place = simpledialog.askstring('Place', 'Please enter a place')
